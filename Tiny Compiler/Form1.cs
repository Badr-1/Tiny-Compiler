...
namespace Tiny_Compiler
{
    public partial class Form1 : Form
    {
        ...
        private void setRegex()
        {
            ...
            Identifiers = "(?![(int|float|string|read|write|repeat|until|if|elseif|else|then|return|endl|end)])([a-zA-Z][a-zA-Z0-9]*)";
